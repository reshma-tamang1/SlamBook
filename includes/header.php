...
include("includes/classes/Notification.php");
	...
	if (isset($_SESSION['username']))  //if the session variable is set then make userloggedin var equal below		
	{
		...
		header("Location:register.php"); //if not set take back to register page
	}
?>
...
<head>
	...
	<link rel="stylesheet" type="text/css" href="assets/css/style.css"><link rel="stylesheet" href="assets/css/jquery.Jcrop.css" type="text/css" />
</head>
<body>
<div class="top_bar">
	<div class="logo ">
		<a href="index.php">SlamBook</a>
	</div>
