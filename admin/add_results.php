...
mysqli_query($connection,"insert into results (result_id,result_name,details, image,result_date) values ('','$result_name','$details','$pic_name','$result_date')") or die ("query incorrect");
...
<body>
	...
	<div class="panel-body" style="background-color:#E6EEEE;">
        ...
        <p>Title</p>
        <input class="input-lg thumbnail form-control" type="text" name="result_name" id="result_name" autofocus style="width:100%" placeholder="result Title" required>
<p>Description</p>
