 ...
 <html>  
      <head>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Users of Different Gender',  
                      is3D:true,  
                      pieHole: 0.4  
                     };  
      ...
      <body>  
           ...
           <div style="width:700px;" align="center" class="pie_chart">
            ...
            <td><i class="fa fa-pie-chart" aria-hidden="true"><b><a href="designation.php"> Designation Chart</a></b></td> </table>
                <h3 align="center"><b>Pie Chart of Users According to Gender</b></h3>  
                <br />  
